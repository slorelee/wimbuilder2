...
$i18n = {
  ...
  "<strong>INFO</strong>:the install.wim isn't exist.":"<strong>주의</strong>:install.wim이 없는데요 헐.",
  "Select the install.wim file if it needed":"필요하다면 install.wim 파일을 선택하세요",
  "<strong>ERROR</strong>:the base wim isn't exist.":"<strong>에러</strong>:베이스 wim이 없는데요 헐.",
  ...
  "Cancel":"취소",
  "0-cleanup":"0-클린업(=정리)",
  "1-run(cmd)":"1-빌드 실행(CMD)",
  "1-exec(log)":"1-빌드 실행(로그)",
  "2-make_iso":"2-ISO 제작",
  "Create ISO after building":" 빌드 후 이어서 ISO 제작까지 진행",
  "Test ISO after building with:":"빌드후 이어서 ISO 테스트할 가상머신 : ",
  "Launch":"가상머신 작동",
